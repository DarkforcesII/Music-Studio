...
namespace Bhaptics.SDK2
{
    public class BhapticsSDK2 : MonoBehaviour
    {
        ...
        {
            string path = Path.Combine(GetBhapticsFolderParentPath(localToAssetsFolder), "SDK2", "Resources");
        ...
        {
            string path = Path.Combine(GetBhapticsFolderParentPath(localToAssetsFolder), "SDK2", "Scripts");
