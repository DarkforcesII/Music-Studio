...
namespace Bhaptics.SDK2
{
    public class BhapticsLibrary
    {
        ...
        public static int PlayGlove(PositionType positionType, int[] motorValues, GlovePlayTime[] playTimeValues, GloveShapeValue[] shapeValues)
        {
            if (!isAvailable)
            {
                return -1;
            ...
            {
                Debug.LogError("[bHaptics] BhapticsLibrary - PlayGlove() 'motorValues, playTimeValues, shapeValues' necessarily require 6 values each.");
                return -1;
            }
